...
'''fp1=open('./mQ/mQ_100_5_config13_no_ext.txt','w')
for perturb in range(0,101):
	frac=float(perturb)/100.0
	str1='./config13_no_ext/config13_p'+str(frac)+'.txt'
	print str1
